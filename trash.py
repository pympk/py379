def _4_perf_ranks_1(df_close, days_lookback, verbose=False):
    ...
    Args:
        ...
        days_lookback(int): positive integer, number of days to look-back for
    ...
    Return:
        perf_ranks_dict({dic): dic. of dic. of symbols ranked in descending
         performance.
         First dic keys are:
          'period' + str(days_lookback[0]), ... ,
          'period' + str(days_lookback[-1])
         Second dic keys are:
        ...
        ranked_perf_ranks_dict(dic): dic. of symbols ranked in descending
         ...
         'ranked_perf_ranks_period' + str(days_lookback), e.g.:
         {'ranked_perf_ranks_period-60': ['HZNP', ... , 'NSC']}
    """
    ...
    ################# ARE COUNTS THE SAME SINCE RETURNING ALL SYMBOLS ################
    l_tuples = (
